...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative flex flex-col items-center justify-center min-h-screen animated-gradient-bg text-foreground py-4 sm:py-6 lg:py-8 px-6 sm:px-8 lg:px-12 overflow-hidden">
      <div className="absolute inset-0 bg-black/20 backdrop-blur-sm"></div> {/* Subtle overlay for text readability on gradient */}
      <div className="relative z-10 text-center space-y-6 sm:space-y-8">
        ...
        <p className="text-xl sm:text-2xl md:text-3xl text-foreground/90 max-w-3xl mx-auto animate-fade-in-up min-h-[3em] sm:min-h-[2.5em] md:min-h-[2em]" style={{ animationDelay: '0.5s' }}>
        ...
        <p className="text-sm sm:text-base md:text-lg text-foreground/80 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.65s' }}>
